...
#proportion
length(lcbenchEvaluation$yval)/length(smashy_lcbench$yval)
#top congifuration
sum(lcbenchYval >= quantile(smashy_lcbench$yval, 0.95))/length(lcbenchYval)
sum(smashy_lcbench$yval >= quantile(smashy_lcbench$yval, 0.95))/length(smashy_lcbench$yval)
```
...
sum(superYval >= quantile(superSmashy$yval, 0.7))/length(superYval)
sum(superYval >= quantile(superSmashy$yval, 0.65))/length(superYval)
```
